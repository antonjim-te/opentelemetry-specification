...
| --- | --- | --- | --- | --- | --- |
| [`error.type`](attributes/thousandeyes.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` | string | Error class of the operation. | `timeout` |
| [`ftp.response.status_code`](attributes/thousandeyes.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` | int | FTP response status code. | |
...
| --- | --- | --- | --- | --- | --- |
| [`error.type`](attributes/thousandeyes.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` | string | Error class of the operation. | `timeout` |
| [`sip.response.status_code`](attributes/thousandeyes.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` | int | SIP response status code. | |
